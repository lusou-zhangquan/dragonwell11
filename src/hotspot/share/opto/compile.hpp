...
class Compile : public Phase {
 ...
 public:
  ...
  public:
    ...
    Constant(BasicType type, float freq = 0.0f, bool can_be_reused = true) :
      _type(type),
      _offset(-1),
      _freq(freq),
  ...
  public:
    ...
    int length() const { return _constants.length(); }
    Constant* get_constant(int i) { return _constants.adr_at(i); }
 ...
 private:
  ...
  bool _has_profile_change_detect_node;
 ...
 public:
  ...
  void                  set_has_profile_change_detect_node() { _has_profile_change_detect_node = true; }
  bool                  has_profile_change_detect_node() const { return _has_profile_change_detect_node; }
